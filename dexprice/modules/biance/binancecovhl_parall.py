...
import dexprice.modules.biance.cexcovhl as cexcovhl



class BinanceOvhlTaskManager:
    def __init__(self, mexcqueue:list[cex_queue.cexkline_create_request_queue], proxies, rate, capacity, max_threads_per_proxy,flag='future',limit=1500,cexname='binance'):
        ...
        while not success and failure_count < max_failures:
            ...
            try:
              ...
              #  tokens_info = geck.get_token_history2(self.chain_id, addressqueue.pool_address, addressqueue.kline, addressqueue.aggregate, addressqueue.before_timestamp, addressqueue.limit, "usd", "base",  proxy.port)
                ...
                historydatas = cexcovhl.biance_token_history_use_queue( queue, proxy.port,self.limit,self.flag,self.cexname)
